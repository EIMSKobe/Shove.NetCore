...
namespace EnterpriseDT.Net.Ftp
{
    ...
    public class FTPClient : IFileTransferClient
    {
        ...
        {            
            ...
            return TimeZoneInfo.ConvertTime(ts, TimeZoneInfo.Local);//.CurrentTimeZone.ToLocalTime(ts);
        }
        ...
        public virtual void SetModTime(string remoteFile, DateTime modTime)
        {
            ...
            DateTime univTime = TimeZoneInfo.ConvertTime(modTime, TimeZoneInfo.Utc); //.CurrentTimeZone.ToUniversalTime(modTime);
